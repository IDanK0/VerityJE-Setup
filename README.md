...
VerityJE-Setup sets up all the AI infrastructure the Verity JE mod needs: speech-to-text (so Verity can hear you), text-to-speech (so Verity can talk back), and the AI gateway (so Verity can think). Cloud or fully local with Ollama - you choose.
